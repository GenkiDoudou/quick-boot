...
import { C7JsonTable, C7Button, C7ButtonGroup } from '@c7-plus';
import {useDict} from '@/composables/useDict';
import {useUtils} from '@/composables/useUtils';

// 使用 composables 替代 getCurrentInstance
const {sys_normal_disable,role_data_scope} = useDict("sys_normal_disable","role_data_scope");
...
const tableProps = ref({
  selection: true,
  showAdd: utils.checkPermission('system:role:add'),
  showEdit: utils.checkPermission('system:role:edit'),
  showDelete: utils.checkPermission('system:role:remove'),
  showRefresh: true,
  showExport: utils.checkPermission('system:role:export'),
  showImport: utils.checkPermission('system:role:import'),
  border: true,
  stripe: true,
  height: 'auto'
});
