...
<script setup>
import {C7JsonTable, C7Button, C7SwitchForm, C7ButtonGroup} from "@c7-plus";
...
const dictData = useDict("sys_normal_disable");
...
const tableProps = ref({
  selection: true,
  showAdd: utils.checkPermission('system:dict:add'),
  showEdit: utils.checkPermission('system:dict:edit'),
  showDelete: utils.checkPermission('system:dict:remove'),
  showRefresh: true,
  showExport: utils.checkPermission('system:dict:export'),
  showImport: utils.checkPermission('system:dict:import'),
  border: true,
  stripe: true,
  height: 'auto'
});
