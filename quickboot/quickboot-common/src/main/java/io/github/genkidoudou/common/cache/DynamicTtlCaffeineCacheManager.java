 ...
 * <p>
 * 每个不同的注解字符串对应独立的 Caffeine 实例，单实例上限 {@link QuickbootCacheDefaults#CAFFEINE_MAX_ENTRIES_PER_CACHE}。
 */
public class DynamicTtlCaffeineCacheManager extends AbstractCacheManager {
    ...
    protected Cache getMissingCache(String name) {
        ...
        com.github.benmanes.caffeine.cache.Cache<Object, Object> nativeCache =
                Caffeine.newBuilder()
                        .maximumSize(QuickbootCacheDefaults.CAFFEINE_MAX_ENTRIES_PER_CACHE)
