 ...
 */
@Configuration
@ConditionalOnClass(org.jeecg.modules.drag.util.g.class)
...
public class JimuDragRedisConfiguration {
    ...
    /**
     * 覆盖官方 {@code DragRedisUtil}（2.5.0 混淆类 {@code util.g}），修复无 Redis 时 increment 解析 ValueWrapper 的缺陷。
     */
    @Bean
    @Primary
    public org.jeecg.modules.drag.util.g fixedDragRedisUtil(
