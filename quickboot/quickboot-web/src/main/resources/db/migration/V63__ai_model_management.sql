-- AI 大模型管理：业务表 + KB/WF 绑定扩展 + 菜单权限迁移
...
ALTER TABLE wf_workflow
    ADD COLUMN chat_model_id BIGINT NULL COMMENT 'Chat 模型 ai_model.model_id，NULL 表示使用 WORKFLOW_CHAT/CHAT 默认' AFTER external_api_enabled;
